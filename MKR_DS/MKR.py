# Посилання: https://ek.ua/ua/list/277/

from json import dump
from requests import get
from bs4 import BeautifulSoup

URL = "https://ek.ua/ua/list/277/"
...
with open("list_prod.xml", "w", encoding="utf-8") as xml_file:
    dump(name_a, span ,xml_file, ensure_ascii="False", indent=4)